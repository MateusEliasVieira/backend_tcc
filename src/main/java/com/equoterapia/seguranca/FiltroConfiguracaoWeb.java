...
public class FiltroConfiguracaoWeb {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/usuario/atualizar-usuario").hasAuthority(RoleEnum.ROLE_ADMIN.name())
                .requestMatchers(HttpMethod.GET, "/usuario/buscar-usuario-por-nome").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/usuario/buscar-usuario-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.DELETE, "/usuario/deletar-usuario").hasAuthority(RoleEnum.ROLE_ADMIN.name())
                // ======================================================================================================================= //
                ...
                .requestMatchers(HttpMethod.POST, "/praticante/evolucao/buscar-evolucao-do-praticante-por-intervalo-de-datas").hasAuthority(RoleEnum.ROLE_USER.name())
                ...
                .requestMatchers(HttpMethod.PUT, "/praticante/completude-matricula/atualizar-completude-matricula-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/completude-matricula/buscar-completude-matricula-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Dados Pessoais
                .requestMatchers(HttpMethod.POST, "/praticante/dados-pessoais/salvar-dados-pessoais-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                ...
                .requestMatchers(HttpMethod.GET, "/praticante/dados-pessoais/buscar-dados-pessoais-do-praticante-por-id-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                ...
                .requestMatchers(HttpMethod.PUT, "/praticante/educacao-praticante/atualizar-educacao-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/educacao-praticante/buscar-educacao-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Emergencia
                .requestMatchers(HttpMethod.POST, "/praticante/emergencia/salvar-emergencia-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/emergencia/atualizar-emergencia-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/emergencia/buscar-emergencia-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Outras Atividades Manha
                .requestMatchers(HttpMethod.POST, "/praticante/outras-atividades-manha/salvar-outras-atividades-manha-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/outras-atividades-manha/atualizar-outras-atividades-manha-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/outras-atividades-manha/buscar-outras-atividades-manha-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Outras Atividades Tarde
                .requestMatchers(HttpMethod.POST, "/praticante/outras-atividades-tarde/salvar-outras-atividades-tarde-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/outras-atividades-tarde/atualizar-outras-atividades-tarde-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/outras-atividades-tarde/buscar-outras-atividades-tarde-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Responsável do Praticante
                .requestMatchers(HttpMethod.POST, "/praticante/responsavel-pelo-praticante/salvar-responsavel-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/responsavel-pelo-praticante/atualizar-responsavel-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/responsavel-pelo-praticante/buscar-responsavel-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                //  *********************************************** Avaliação Fisioterapeutica *******************************************
                // # Avaliação Fisioterapeutica
                .requestMatchers(HttpMethod.POST, "/praticante/avaliacao-fisioterapeutica/salvar-avaliacao-fisioterapeutica-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/avaliacao-fisioterapeutica/atualizar-avaliacao-fisioterapeutica-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/avaliacao-fisioterapeutica/buscar-avaliacao-fisioterapeutica-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Coordenacao Motora
                ...
                .requestMatchers(HttpMethod.GET, "/praticante/equilibrio-dinamico/buscar-equilibrio-dinamico-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Equilibrio Estatico
                .requestMatchers(HttpMethod.POST, "/praticante/equilibrio-estatico/salvar-equilibrio-estatico-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/equilibrio-estatico/atualizar-equilibrio-estatico-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/equilibrio-estatico/buscar-equilibrio-estatico-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Forma de Comunicação
                .requestMatchers(HttpMethod.POST, "/praticante/forma-comunicacao/salvar-forma-comunicacao-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/forma-comunicacao/atualizar-forma-comunicacao-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/forma-comunicacao/buscar-forma-comunicacao-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Grupos Musculares
                .requestMatchers(HttpMethod.POST, "/praticante/grupos-musculares/salvar-grupos-musculares-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/grupos-musculares/atualizar-grupos-musculares-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/grupos-musculares/buscar-grupos-musculares-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Habilidades Motoras AVD
                .requestMatchers(HttpMethod.POST, "/praticante/habilidades-motoras-avd/salvar-habilidades-motoras-avd-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/habilidades-motoras-avd/atualizar-habilidades-motoras-avd-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/habilidades-motoras-avd/buscar-habilidades-motoras-avd-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Mobilidade Articular
                .requestMatchers(HttpMethod.POST, "/praticante/mobilidade-articular/salvar-mobilidade-articular-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/mobilidade-articular/atualizar-mobilidade-articular-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/mobilidade-articular/buscar-mobilidade-articular-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Quadro Atual
                .requestMatchers(HttpMethod.POST, "/praticante/quadro-atual/salvar-quadro-atual-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/quadro-atual/atualizar-quadro-atual-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/quadro-atual/buscar-quadro-atual-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())
                // # Saude Geral dos Praticantes
                .requestMatchers(HttpMethod.POST, "/praticante/saude-geral-do-praticante/salvar-saude-geral-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.PUT, "/praticante/saude-geral-do-praticante/atualizar-saude-geral-do-praticante").hasAuthority(RoleEnum.ROLE_USER.name())
                .requestMatchers(HttpMethod.GET, "/praticante/saude-geral-do-praticante/buscar-saude-geral-do-praticante-por-id").hasAuthority(RoleEnum.ROLE_USER.name())

package com.equoterapia.seguranca.jwt;
...
public class JwtToken {
	...
	public static String generateTokenJWT(Usuario user)
	{
		try{
			String token = JWT.create()
					.withSubject(user.getNomeUsuario()) // (Payload) define para quem é esse token (Sujeito)
					...
					.withClaim("idUser", user.getIdUsuario()) // (Payload) id do usuário

...
public class SaudeGeralDoPraticanteControlador {
    ...
    public ResponseEntity<?> salvarSaudeGeralDosPraticantes(@RequestBody @Valid SaudeGeralDosPraticantesEntradaDTO saudeGeralDosPraticantesEntradaDTO) {
        SaudeGeralDoPraticante saudeGeralDoPraticante = PraticanteMapeador.converterSaudeGeralDosPraticantesEntradaDTOEmSaudeGeralDosPraticantes(saudeGeralDosPraticantesEntradaDTO);
    ...
    public ResponseEntity<?> atualizarSaudeGeralDosPraticantes(@RequestBody @Valid SaudeGeralDosPraticantesEntradaDTO saudeGeralDosPraticantesEntradaDTO) {
        SaudeGeralDoPraticante saudeGeralDoPraticante = PraticanteMapeador.converterSaudeGeralDosPraticantesEntradaDTOEmSaudeGeralDosPraticantes(saudeGeralDosPraticantesEntradaDTO);
